...
if __name__ == "__main__":
    ...
    base2drone_omni = pd.read_csv('Lige_SINR.csv')
    drone2base_omni = pd.read_csv('Trorhamerbias.csv')
    ...
    plot_radio_over_tid(drone2base_omni, "Signalmålinger: Drone 3 -> Base 1")
